...
public class CharArrayDeleteManagerImplTest {

    CharArrayDeleteManagerImpl symArrayDeleteManager;
    ...
    @BeforeMethod
    public void setUp() {
        symArrayDeleteManager=new CharArrayDeleteManagerImpl();
    }

    @Test
    public void deleteNonLetterSymbolsTest() throws CustomException {
        String actual =symArrayDeleteManager.deleteNonLetterSymbols(fileContent),
    ...
    public void deleteWordTest() throws CustomException {
        String actual =symArrayDeleteManager.deleteWord(fileContent, 2),
