...
public class StringReplaceManagerImplTest {
    ...
    String firstFileContent = "He turned to look at her, and she was smiling at him. It was Noys as she had been, and his own heart beating as it had used to.\n" +
            ...
            secondFileContent = "palypropylene chlordiazepaxide palycarbonate dispropartionate paliomyelitis occipitotemparal";
    ...
    public void replaceWordBySubStrEqualTest() throws CustomException {
        String expected = "OO turned OO look OO her, and she was smiling OO him. OO was Noys OO she had been, and his own heart beating OO OO had used OO.\n" +
                ...
                actual = stringReplaceManager.replaceWordBySubStr(firstFileContent,"OO",2);
    ...
    public void replaceWordBySubStrLessTest() throws CustomException {
        String expected = "O turned O look O her, and she was smiling O him. O was Noys O she had been, and his own heart beating O O had used O.\n" +
                ...
                actual = stringReplaceManager.replaceWordBySubStr(firstFileContent,"O",2);
        assertEquals(actual,expected);
    }
    ...
    public void replaceWordBySubStrBiggerTest() throws CustomException {
        String expected = "OOO turned OOO look OOO her, and she was smiling OOO him. OOO was Noys OOO she had been, and his own heart beating OOO OOO had used OOO.\n" +
                ...
                actual = stringReplaceManager.replaceWordBySubStr(firstFileContent,"OOO",2);
        assertEquals(actual,expected);
    }
    ...
    public void replaceSymbolInWordTest() throws CustomException {
        String expected = "He turned to look at her, and she was smilin+ at him. It was Noys as she had been, and his own heart beatin+ as it had used to.\n" +
                ...
                actual = stringReplaceManager.replaceSymbolInWord(firstFileContent,7,'+');
        assertEquals(actual,expected);
    }

    @Test
    public void correctMistakeTest() throws CustomException {
        String expected = "polypropylene chlordiazepoxide polycarbonate disproportionate poliomyelitis occipitotemporal",
                actual = stringReplaceManager.correctMistake(secondFileContent,"pa","po");
